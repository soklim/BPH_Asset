...
{{--    @include ('partials.forms.edit.company-select', ['translated_name' => trans('general.company'), 'fieldname' => 'company_id'])--}}
  ...
  @if (!$item->id)
      @include ('partials.forms.checkout-selector', ['user_select' => 'true','location_select' => 'true', 'style' => 'display:none;'])
...
{{--  @include ('partials.forms.edit.asset-select', ['translated_name' => trans('admin/hardware/form.checkout_to'), 'fieldname' => 'assigned_asset', 'style' => 'display:none;', 'required' => 'false'])--}}
  ...
  @include ('partials.forms.edit.location-select', ['translated_name' => 'Project', 'fieldname' => 'rtd_location_id'])
